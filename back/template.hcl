...
env_template "ADMIN_JWT_SECRET" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.ADMIN_JWT_SECRET }}{{ end }}"
  error_on_missing_key = true
}
env_template "API_TOKEN_SALT" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.API_TOKEN_SALT }}{{ end }}"
  error_on_missing_key = true
}
env_template "APP_KEYS" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.APP_KEYS }}{{ end }}"
  error_on_missing_key = true
}
env_template "DATABASE_HOST" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.DATABASE_HOST }}{{ end }}"
  error_on_missing_key = true
}
env_template "DATABASE_NAME" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.DATABASE_NAME }}{{ end }}"
  error_on_missing_key = true
}
env_template "DATABASE_PORT" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.DATABASE_PORT }}{{ end }}"
  error_on_missing_key = true
}
env_template "JWT_SECRET" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.JWT_SECRET }}{{ end }}"
  error_on_missing_key = true
}
env_template "MINIO_BUCKET" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.MINIO_BUCKET }}{{ end }}"
  error_on_missing_key = true
}
env_template "MINIO_FOLDER" {
  contents             = "{{ with secret \"dev-env/data/toolbox-gen-project3\" }}{{ .Data.data.MINIO_FOLDER }}{{ end }}"
  error_on_missing_key = true
}
